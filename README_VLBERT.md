...
VLC-BERT extends VL-BERT to incorporate contextualized commonsense for external knowledge visual questioning tasks.

The following README is from VL-BERT.
